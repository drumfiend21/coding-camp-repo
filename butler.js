...
//  This is Butler.  It matches a tie color to your shirt or jacket depending on the energy you want to portray.  //
...
var proceed = confirm("Shall we use our complex matching system to pick a tie for you today?")
...
if(proceed === true)
	...
	if(energy === "1")
		...
		if(energy === "1")
			...
			{
			console.log("We are matching so your look conveys a conservative energy.");s
			}
		else if(energy === "3")
			{
			console.log("We are matching so your look conveys a mute sophisticated energy.");
